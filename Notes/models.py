...
class Note(models.Model):
    ...
    subject = models.CharField(verbose_name='Тема', max_length=50, help_text='Тема', blank=True, null=True)
    body = models.CharField(verbose_name='Содержание', max_length=300, help_text='Содержание')
    private_note = models.BooleanField(verbose_name='Личная', help_text='Личная', default=False)
